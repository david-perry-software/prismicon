...
export { wright, WRIGHT_SPEC_VERSION } from './wright.js';
...
export const BUILT_IN_VARIANTS = createVariantRegistry([polyhedron, ...ncubeVariants, orbit, wright], { defaultId: DEFAULT_VARIANT_ID });
